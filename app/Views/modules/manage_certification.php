...
<!-- PAGE 14 - Content Box with Table -->
                ...
                <?php if ($requests): ?>
                    <?php foreach ($requests as $request): ?>
                        <tr>
                            ...
                            <td>1</td>
                            <td>
                                <!-- ✅ UPDATED: Added middle_name and contact_no parameters -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="justify-content: center;">
                    ...
                    <!-- ✅ CHANGE 1: Changed to button with data-bs-target -->
